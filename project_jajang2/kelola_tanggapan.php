		...
		<div class="page-wrapper">
			<div class="page-content">
				...
				<!-- membuat card yang diisi dengan tampilan tabel data | baris 63 - 196 -->
				 <div class="card">
            <div class="card-header bg-info text-white">Laporan Data Pengaduan</div>
            <div class="card-body">
                <table id="dataTanggapan" class="display nowrap" style="width:100%">
                    ...
                    <tbody>
                        <?php
                        $no = 1;
                        $tampil = mysqli_query($koneksi, "SELECT dat_pengaduan.id as id_pengaduan, dat_pengaduan.nik, dat_pengaduan.judul, dat_pengaduan.gambar, dat_pengaduan.deskripsi, dat_pengaduan.tgl_pengaduan, dat_pengaduan.status_pengaduan, dat_masyarakat.*, dat_tanggapan.*, dat_petugas.* FROM dat_pengaduan
                        LEFT JOIN dat_masyarakat ON dat_pengaduan.nik = dat_masyarakat.nik 
                        LEFT JOIN dat_tanggapan ON dat_pengaduan.id = dat_tanggapan.id_pengaduan
                        LEFT JOIN dat_petugas ON dat_tanggapan.id_petugas = dat_petugas.id
                        ...
                        ?>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="" class="btn btn-success" data-bs-toggle="modal" data-bs-target="#detailTanggapan<?php echo $data['id_pengaduan']; ?>">Detail</a>
                                    <a href="" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#ubahkelolaPengaduan<?php echo $data['id_pengaduan']; ?>">Ubah</a>
                                </td>
                            </tr>

                            <!-- Modal Kelola Pengaduan -->
                            <div class="modal fade" id="ubahkelolaPengaduan<?php echo $data['id_pengaduan']; ?>" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <form action="crud_kelola_tanggapan.php" method="post" enctype="multipart/form-data">
                                                <input type="hidden" name="id_pengaduan" value="<?php echo $data['id_pengaduan']; ?>">
                                                <div class="mb-3">
                                                    <label for="">Konfirmasi Aduan</label>
                                                    <select name="status_pengaduan" class="form-control" id="">
                                                        <option value="tolak" <?php echo $data['status_pengaduan'] == 'tolak' ? 'selected' : '' ?>>Tolak</option>
                                                        <option value="terima" <?php echo $data['status_pengaduan'] == 'terima' ? 'selected' : '' ?>>Terima</option>
                                                    </select>
                                                </div>
                                                <div class="mb-3">
                                                    <label for="">Isi Tanggapan</label>
                                                    <textarea name="tanggapan" id="" rows="6" class="form-control"><?php echo $data['tanggapan'] ?></textarea>
                                                </div>
